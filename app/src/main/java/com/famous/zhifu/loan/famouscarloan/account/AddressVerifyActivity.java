...
public class AddressVerifyActivity extends Activity implements
		ActivityInterface, OnClickListener {
	private View mView;
	private TextView mTvTitle;
	private ImageView mIvRight, mIvLeft;
	private Button submit;
	private EditText editName,editPhone,editPostcode,editAddress;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
		super.onCreate(savedInstanceState);
		mView = getLayoutInflater().inflate(R.layout.activity_address_verify,
				null);
	...
	public void findView() {
		...
		editPostcode = (EditText) mView.findViewById(R.id.editPostcode);
		editAddress = (EditText) mView.findViewById(R.id.editAddress);
	}

	@Override
	public void initData() {
		mTvTitle.setText(getResources().getString(R.string.verify_address));
