...
import com.famous.zhifu.loan.util.AbFileUtil;
...
public class AbSlidingPlayView extends LinearLayout {
	...
	public void initView(Context context) {
		...
		mNavLayoutParent.setPadding(0, 25, 0, 25);
		...
		addView(mRelativeLayout, new LinearLayout.LayoutParams(
	...
	public void makesurePosition() {
		...
		// 修改后代码 用于是viewPager的定位点可以循环变动
		position = mViewPager.getCurrentItem() % mListViews.size();
		for (int j = 0; j < count; j++) {
			if (position == j) {
