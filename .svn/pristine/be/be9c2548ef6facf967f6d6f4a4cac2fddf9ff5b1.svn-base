...
public class ContactVerifyActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mView = getLayoutInflater().inflate(R.layout.activity_contact_verify,
				null);
	...
	public void initData() {
		mTvTitle.setText(getResources().getString(R.string.verify_contacts));
