...
public class ChangePasswordVerifyActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mView = getLayoutInflater().inflate(
				R.layout.activity_change_password_verify, null);
			...
			try {
				if (data.getInt("errorcode") == 0) {
					if (!TextUtils.isEmpty(data.get("dataresult").toString())) {
						...
						Toast.makeText(ChangePasswordVerifyActivity.this,
				...
				try {
					...
					Toast.makeText(ChangePasswordVerifyActivity.this, str, 1)
							.show();
